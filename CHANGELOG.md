...
- **Virtual Message List**: Buffer-based virtualization for long conversations with DOM height reading and scroll-to-index support.
- **Inspector Panel**: Right-side 三栏 panel foundation with model info, trace, tool detail, and artifact modes.
...
- **562 tests passing** across 37 test files (6 skipped due to IndexedDB environment limitations).

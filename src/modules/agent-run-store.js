...
export function applyCrewToolRequest(agentRun, tool = {}) {
...
export function applyCrewToolResult(agentRun, event = {}, toolCalls = []) {
  if (!agentRun || !agentRun.crew) return;
...
export function handleCrewAgentStage(agentRun, stageEvent = {}) {
  if (!agentRun || !agentRun.crew) return;

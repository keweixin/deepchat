...
export { uid, truncate, escapeHtml } from './shared-utils.js';

let toastTimer: ReturnType<typeof setTimeout> | null = null;

/** Debounce function */
export function debounce<T extends (...args: unknown[]) => void>(fn: T, ms: number = 150): T {
...
/** Format timestamp to HH:MM (today), 昨天 HH:MM (yesterday), or MM-DD HH:MM */
...
export function scrollToBottom(el: HTMLElement, smooth: boolean = true): void {
  el.scrollTo({
    top: el.scrollHeight,
